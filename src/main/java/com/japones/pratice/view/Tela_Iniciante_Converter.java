 ...
 * @author Suporte TI
 */
public class Tela_Iniciante_Converter extends javax.swing.JFrame {
	...
	private static String contexto = "r2h";
	private static PalavraSorteada palavra;
	private static Connection conexao = Tela_Inicial.getConexao();
	private static int quantidade_treino = 25;
	...
	public Tela_Iniciante_Converter() throws SQLException {
		initComponents();
	...
	private void initComponents() throws SQLException {
		...
		jLabelRespostaCorreta.setFont(new java.awt.Font("UD Digi Kyokasho N-B", 1, 36)); // NOI18N
	...
	private void jButtonSairActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonSairActionPerformed
		Tela_Sair_Confirma.setContexto(4);
		item_atual = 0;
	...
	private void jButtonProximoActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {// GEN-FIRST:event_jButtonProximoActionPerformed
		...
		if (item_atual < quantidade_treino) {
			...
			if (!praticar_tudo)
				...
				if (contexto.equals("r2h") || contexto.equals("r2k")) {

				
					Tela_Mensagem.setContexto(tipo_atividade + "2r");
	...
	private void jButtonConferirActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonConferirActionPerformed
		...
		if(contexto.equals("r2h") || contexto.equals("r2k")) {
			...
			jLabelRespostaCorreta.setText(palavra.getResposta());
			
			
		}else {
		String resposta_usuario = jTextFieldRespostaUsuario.getText().toLowerCase().replace(" ", "");

		if (resposta_usuario.equals(palavra.getResposta())) {
	...
	private void formatarContexto(){
		Controller controller = new Controller();
		switch (contexto) {
			case "r2h":
				jTextFieldRespostaUsuario.setEnabled(false);
				jTextFieldRespostaUsuario.setText("Escreva em um caderno.");
				palavra = controller.sortearPalavraRomajiHiragana(lista);
				jLabelImagem.setText(palavra.getPalavra());
				jLabelImagem.setFont(new java.awt.Font("Calibri", 1, 60));
				break;
				
			case "r2k":
				jTextFieldRespostaUsuario.setEnabled(false);
				jTextFieldRespostaUsuario.setText("Escreva em um caderno.");
				palavra = controller.sortearPalavraRomajiKatakana(lista);
				jLabelImagem.setText(palavra.getPalavra());
				jLabelImagem.setFont(new java.awt.Font("Calibri", 1, 60));
				break;
				
			case "h2r":
				jTextFieldRespostaUsuario.setEnabled(true);
				jTextFieldRespostaUsuario.setText("");
				palavra = controller.sortearPalavraHiragana(lista);
				jLabelImagem.setText(palavra.getPalavra());
				break;
			...
			case "k2r":
				jTextFieldRespostaUsuario.setEnabled(true);
				jTextFieldRespostaUsuario.setText("");
				palavra = controller.sortearPalavraKatakana(lista);
				jLabelImagem.setText(palavra.getPalavra());
				break;
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(Tela_Iniciante_Converter.class.getName())
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					new Tela_Iniciante_Converter().setVisible(true);
				} catch (SQLException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
